  ...
  <div class="space-y-6">
    ...
    <div v-else class="space-y-4">
      ...
      >
        ...
        <div v-if="getAccountsByClass(classItem.code).length > 0" class="divide-y">
          <div
          ...
          >
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <span :class="cn('text-xs px-2 py-0.5 rounded-full', getAccountTypeColor(account.type))">
                  {{ getAccountTypeLabel(account.type) }}
                </span>
              </div>
            </div>
            <div class="flex items-center gap-4">
              <span :class="cn('font-medium', account.balance < 0 ? 'text-red-600' : 'text-green-600')">
