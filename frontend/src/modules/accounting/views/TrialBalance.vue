...
import { Scale, Download, Calendar } from 'lucide-vue-next'
import { cn } from '@/lib/utils'

const { trialBalance, isLoading, formatCurrency, getAccountTypeColor } = useAccounting()
      ...
      <table class="w-full text-sm">
        <thead class="bg-muted/50">
          <tr>
            <th
              rowspan="2"
              class="text-left p-3 font-medium border-r"
            >
              Compte
            </th>
            <th
            ...
            <th
              colspan="2"
              class="text-center p-2 font-medium border-b border-r"
            >
              Soldes d'ouverture
            </th>
            <th
            ...
            <th
              colspan="2"
              class="text-center p-2 font-medium border-b"
            >
              Soldes de cloture
            </th>
          </tr>
        ...
        <tbody class="divide-y">
          ...
          >
            ...
            <td class="p-3 border-r">
              ...
              <span
                :class="
                  cn('ml-2 text-xs px-1 py-0.5 rounded', getAccountTypeColor(entry.accountType))
                "
              >
                {{ entry.accountType }}
              </span>
            ...
            <td class="p-3 text-right border-r">
