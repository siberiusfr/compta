        ...
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2 mb-1">
              ...
              <span
                v-if="doc.metadata?.endDate && daysUntilEnd(doc.metadata.endDate)! <= 30 && daysUntilEnd(doc.metadata.endDate)! > 0"
            ...
            <div class="flex flex-wrap items-center gap-4 mt-2 text-sm text-muted-foreground">
              <span v-if="doc.metadata?.startDate" class="flex items-center gap-1">
              ...
              <span v-if="doc.metadata?.renewalType" class="flex items-center gap-1">
          ...
          <!-- Value -->
          <div v-if="doc.metadata?.value" class="text-right">
