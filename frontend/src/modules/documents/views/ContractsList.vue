...
const { contracts, isLoading, formatCurrency, formatDate, getStatusColor } = useDocuments()
        ...
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2 mb-1">
              <h3 class="font-semibold">{{ contract.contractNumber }}</h3>
            ...
            <p class="text-sm font-medium">{{ contract.partyName }}</p>
            ...
            <div class="flex flex-wrap items-center gap-4 mt-2 text-sm text-muted-foreground">
              ...
              <span class="flex items-center gap-1">
                ...
                {{ renewalLabels[contract.renewalType] }}
              </span>
            </div>
          </div>

          <!-- Value -->
          <div class="text-right" v-if="contract.value">
            <p class="text-lg font-bold">{{ formatCurrency(contract.value) }}</p>
