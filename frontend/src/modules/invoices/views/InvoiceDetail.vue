  ...
  <div v-if="invoice" class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-2">
        ...
        <Button v-if="invoice.status === 'draft'" @click="handleEdit">
        ...
        <div class="rounded-xl border bg-card p-6">
          ...
          <table class="w-full">
            ...
            <tfoot class="border-t mt-4">
              <tr>
                <td colspan="4" class="pt-4 text-right text-muted-foreground">
                  Sous-total
                </td>
              ...
              <tr v-if="invoice.discountTotal > 0">
                <td colspan="4" class="pt-2 text-right text-muted-foreground">
                  Remise
                </td>
