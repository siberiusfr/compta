...
const { companyId, useGetFournisseurById, useUpdateFournisseur, invalidateFournisseurs } =
  useReferentiel()
...
const { data: fournisseur, isLoading } = useGetFournisseurById(companyId, id)
  ...
  <div class="space-y-6 max-w-3xl">
    ...
    <div class="flex items-center gap-4">
      ...
      <div>
        ...
        <p class="text-muted-foreground">Modifiez les informations du fournisseur</p>
      </div>
    </div>
