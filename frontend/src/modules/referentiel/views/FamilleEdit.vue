...
const { companyId, useGetFamilleById, useUpdateFamille, invalidateFamilles } = useReferentiel()
...
const { data: famille, isLoading } = useGetFamilleById(companyId, id)
  ...
  <div class="space-y-6 max-w-2xl">
    ...
    <div class="flex items-center gap-4">
      ...
      <div>
        ...
        <p class="text-muted-foreground">Modifiez les informations de la famille</p>
      </div>
    </div>
