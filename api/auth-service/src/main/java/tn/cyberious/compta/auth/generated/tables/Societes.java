...
public class Societes extends TableImpl<SocietesRecord> {
    ...
    public List<ForeignKey<SocietesRecord, ?>> getReferences() {
        return Arrays.asList(Keys.SOCIETES__SOCIETES_CREATED_BY_FKEY, Keys.SOCIETES__SOCIETES_UPDATED_BY_FKEY);
    }

    private transient UsersPath _societesCreatedByFkey;

    /**
     * Get the implicit join path to the <code>auth.users</code> table, via the
     * <code>societes_created_by_fkey</code> key.
     */
    ...
    /**
     * Get the implicit join path to the <code>auth.users</code> table, via the
     * <code>societes_updated_by_fkey</code> key.
     */
     ...
     * <code>auth.comptable_societes</code> table
     */
    ...
    /**
     * Get the implicit to-many join path to the <code>auth.employees</code>
     * table
     */
    ...
    /**
     * Get the implicit to-many join path to the <code>auth.user_societes</code>
     * table
     */
    ...
    /**
     * Get the implicit many-to-many join path to the <code>auth.users</code>
     * table, via the <code>comptable_societes_user_id_fkey</code> key
     */
    ...
    /**
     * Get the implicit many-to-many join path to the <code>auth.users</code>
     * table, via the <code>user_societes_user_id_fkey</code> key
     */
