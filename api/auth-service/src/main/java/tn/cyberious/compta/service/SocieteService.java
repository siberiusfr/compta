...
public class SocieteService {
  ...
  public List<Societes> getAllSocietes(CustomUserDetails currentUser) {
    ...
    List<tn.cyberious.compta.enums.Role> roles =
        userRepository.findRolesByUserId(currentUser.getId());
  ...
  public Societes createSociete(CreateSocieteRequest request, CustomUserDetails currentUser) {
    log.info(
        "Creating societe: {} by user: {}", request.getRaisonSociale(), currentUser.getUsername());
  ...
  @Transactional
  public Societes updateSociete(
      Long id, UpdateSocieteRequest request, CustomUserDetails currentUser) {
  ...
  public void assignComptableToSociete(
      ComptableSocieteRequest request, CustomUserDetails currentUser) {
    log.info(
        "Assigning comptable {} to societe {} by {}",
        request.getUserId(),
    ...
    comptableSocieteRepository.assignComptableToSociete(
        request.getUserId(), request.getSocieteId(), request.getDateDebut(), request.getDateFin());
  }
