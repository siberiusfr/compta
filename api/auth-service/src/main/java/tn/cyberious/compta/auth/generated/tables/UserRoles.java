...
public class UserRoles extends TableImpl<UserRolesRecord> {
  ...
  public final TableField<UserRolesRecord, Long> ID =
      createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /** The column <code>auth.user_roles.user_id</code>. */
  public final TableField<UserRolesRecord, Long> USER_ID =
      createField(DSL.name("user_id"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>auth.user_roles.role_id</code>. */
  public final TableField<UserRolesRecord, Long> ROLE_ID =
      createField(DSL.name("role_id"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>auth.user_roles.created_at</code>. */
  public final TableField<UserRolesRecord, LocalDateTime> CREATED_AT =
      createField(
          DSL.name("created_at"),
  ...
  private UserRoles(
      Name alias, Table<UserRolesRecord> aliased, Field<?>[] parameters, Condition where) {
  ...
  public <O extends Record> UserRoles(
      Table<O> path,
      ForeignKey<O, UserRolesRecord> childPath,
      InverseForeignKey<O, UserRolesRecord> parentPath) {
  ...
  public List<ForeignKey<UserRolesRecord, ?>> getReferences() {
    return Arrays.asList(
        Keys.USER_ROLES__USER_ROLES_ROLE_ID_FKEY, Keys.USER_ROLES__USER_ROLES_USER_ID_FKEY);
  }
