...
import tn.cyberious.compta.auth.dto.AssignRoleRequest;
...
import tn.cyberious.compta.auth.service.UserManagementService;
...
public class UserController {
  ...
  @Operation(
      ...
      description = "Get user details by ID (ADMIN or COMPTABLE)")
  ...
  @Operation(
      ...
      description = "Get all roles for a user (ADMIN or COMPTABLE)")
  ...
  public ResponseEntity<Void> assignRole(
      ...
      @AuthenticationPrincipal CustomUserDetails currentUser) {
    log.info(
        "Request to assign role {} to user {} by {}",
        request.getRoleName(),
        id,
  ...
  @Operation(
      ...
      description = "Remove a role from user (ADMIN only)")
