...
public class Roles extends TableImpl<RolesRecord> {
  ...
  /** The column <code>auth.roles.id</code>. */
  public final TableField<RolesRecord, Long> ID =
      createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /** The column <code>auth.roles.name</code>. */
  public final TableField<RolesRecord, String> NAME =
      createField(DSL.name("name"), SQLDataType.VARCHAR(50).nullable(false), this, "");

  /** The column <code>auth.roles.description</code>. */
  public final TableField<RolesRecord, String> DESCRIPTION =
      createField(DSL.name("description"), SQLDataType.VARCHAR(255), this, "");

  /** The column <code>auth.roles.created_at</code>. */
  public final TableField<RolesRecord, LocalDateTime> CREATED_AT =
      createField(
          DSL.name("created_at"),
  ...
  public <O extends Record> Roles(
      Table<O> path,
      ForeignKey<O, RolesRecord> childPath,
      InverseForeignKey<O, RolesRecord> parentPath) {
  ...
  /** Get the implicit many-to-many join path to the <code>auth.users</code> table */
