...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, Boolean> IS_LOCKED = createField(DSL.name("is_locked"), SQLDataType.BOOLEAN.defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)), this, "");
     ...
     */
    public final TableField<UsersRecord, LocalDateTime> PASSWORD_CHANGED_AT = createField(DSL.name("password_changed_at"), SQLDataType.LOCALDATETIME(6), this, "");
     ...
     */
    public final TableField<UsersRecord, Long> CREATED_BY = createField(DSL.name("created_by"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>auth.users.updated_by</code>.
     */
    public final TableField<UsersRecord, Long> UPDATED_BY = createField(DSL.name("updated_by"), SQLDataType.BIGINT, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_USERS_EMAIL, Indexes.IDX_USERS_IS_ACTIVE, Indexes.IDX_USERS_USERNAME);
    }
    ...
    /**
     * Get the implicit to-many join path to the <code>auth.auth_logs</code>
     * table
     */
    public AuthLogsPath authLogs() {
        if (_authLogs == null)
            _authLogs = new AuthLogsPath(this, null, Keys.AUTH_LOGS__AUTH_LOGS_USER_ID_FKEY.getInverseKey());
    ...
    public ComptableSocietesPath comptableSocietes() {
        if (_comptableSocietes == null)
            _comptableSocietes = new ComptableSocietesPath(this, null, Keys.COMPTABLE_SOCIETES__COMPTABLE_SOCIETES_USER_ID_FKEY.getInverseKey());
    ...
    public EmployeesPath employees() {
        if (_employees == null)
            _employees = new EmployeesPath(this, null, Keys.EMPLOYEES__EMPLOYEES_USER_ID_FKEY.getInverseKey());
    ...
    /**
     * Get the implicit to-many join path to the
     * <code>auth.refresh_tokens</code> table
     */
    ...
    /**
     * Get the implicit to-many join path to the <code>auth.societes</code>
     * table, via the <code>societes_created_by_fkey</code> key
     */
    public SocietesPath societesCreatedByFkey() {
        if (_societesCreatedByFkey == null)
            _societesCreatedByFkey = new SocietesPath(this, null, Keys.SOCIETES__SOCIETES_CREATED_BY_FKEY.getInverseKey());
    ...
    /**
     * Get the implicit to-many join path to the <code>auth.societes</code>
     * table, via the <code>societes_updated_by_fkey</code> key
     */
    public SocietesPath societesUpdatedByFkey() {
        if (_societesUpdatedByFkey == null)
            _societesUpdatedByFkey = new SocietesPath(this, null, Keys.SOCIETES__SOCIETES_UPDATED_BY_FKEY.getInverseKey());
    ...
    /**
     * Get the implicit to-many join path to the <code>auth.user_roles</code>
     * table
     */
    ...
    public UserSocietesPath userSocietes() {
        if (_userSocietes == null)
            _userSocietes = new UserSocietesPath(this, null, Keys.USER_SOCIETES__USER_SOCIETES_USER_ID_FKEY.getInverseKey());

        return _userSocietes;
    }

    /**
     * Get the implicit many-to-many join path to the <code>auth.societes</code>
     * table, via the <code>comptable_societes_societe_id_fkey</code> key
     */
    ...
    /**
     * Get the implicit many-to-many join path to the <code>auth.roles</code>
     * table
     */
    ...
    /**
     * Get the implicit many-to-many join path to the <code>auth.societes</code>
     * table, via the <code>user_societes_societe_id_fkey</code> key
     */
