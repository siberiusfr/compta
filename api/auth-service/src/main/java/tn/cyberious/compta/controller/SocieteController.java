...
public class SocieteController {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN', 'COMPTABLE')")
    @Operation(summary = "Update societe", description = "Update company information (ADMIN or COMPTABLE)")
    public ResponseEntity<Societes> updateSociete(@PathVariable Long id,
    ...
    @Operation(summary = "Assign comptable to societe", description = "Create comptable-societe association (ADMIN only)")
    public ResponseEntity<Void> assignComptable(@Valid @RequestBody ComptableSocieteRequest request,
                                                 @AuthenticationPrincipal CustomUserDetails currentUser) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Remove comptable from societe", description = "Remove comptable-societe association (ADMIN only)")
    public ResponseEntity<Void> removeComptable(@PathVariable Long userId,
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'COMPTABLE')")
    @Operation(summary = "Assign user to societe", description = "Create user-societe association (ADMIN or COMPTABLE)")
    public ResponseEntity<Void> assignUserToSociete(@Valid @RequestBody UserSocieteRequest request,
                                                     @AuthenticationPrincipal CustomUserDetails currentUser) {
    ...
    public ResponseEntity<Void> removeUserFromSociete(@PathVariable Long userId,
                                                       @PathVariable Long societeId,
                                                       @AuthenticationPrincipal CustomUserDetails currentUser) {
