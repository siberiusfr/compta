  ...
  public static final ForeignKey<ComptableSocietesRecord, SocietesRecord>
      COMPTABLE_SOCIETES__COMPTABLE_SOCIETES_SOCIETE_ID_FKEY =
          Internal.createForeignKey(
              ...
              new TableField[] {Societes.SOCIETES.ID},
              true);
  public static final ForeignKey<ComptableSocietesRecord, UsersRecord>
      COMPTABLE_SOCIETES__COMPTABLE_SOCIETES_USER_ID_FKEY =
          Internal.createForeignKey(
              ComptableSocietes.COMPTABLE_SOCIETES,
              DSL.name("comptable_societes_user_id_fkey"),
              new TableField[] {ComptableSocietes.COMPTABLE_SOCIETES.USER_ID},
              Keys.USERS_PKEY,
              new TableField[] {Users.USERS.ID},
              true);
  public static final ForeignKey<EmployeesRecord, SocietesRecord>
      EMPLOYEES__EMPLOYEES_SOCIETE_ID_FKEY =
          Internal.createForeignKey(
              ...
              new TableField[] {Societes.SOCIETES.ID},
              true);
  public static final ForeignKey<EmployeesRecord, UsersRecord> EMPLOYEES__EMPLOYEES_USER_ID_FKEY =
      Internal.createForeignKey(
          Employees.EMPLOYEES,
          DSL.name("employees_user_id_fkey"),
          new TableField[] {Employees.EMPLOYEES.USER_ID},
          Keys.USERS_PKEY,
          new TableField[] {Users.USERS.ID},
          true);
  public static final ForeignKey<RefreshTokensRecord, UsersRecord>
      REFRESH_TOKENS__REFRESH_TOKENS_USER_ID_FKEY =
          Internal.createForeignKey(
              ...
              new TableField[] {Users.USERS.ID},
              true);
  public static final ForeignKey<SocietesRecord, UsersRecord> SOCIETES__SOCIETES_CREATED_BY_FKEY =
      Internal.createForeignKey(
          Societes.SOCIETES,
          DSL.name("societes_created_by_fkey"),
          new TableField[] {Societes.SOCIETES.CREATED_BY},
          Keys.USERS_PKEY,
          new TableField[] {Users.USERS.ID},
          true);
  public static final ForeignKey<SocietesRecord, UsersRecord> SOCIETES__SOCIETES_UPDATED_BY_FKEY =
      Internal.createForeignKey(
          Societes.SOCIETES,
          DSL.name("societes_updated_by_fkey"),
          new TableField[] {Societes.SOCIETES.UPDATED_BY},
          Keys.USERS_PKEY,
          new TableField[] {Users.USERS.ID},
          true);
  ...
  public static final ForeignKey<UserSocietesRecord, SocietesRecord>
      USER_SOCIETES__USER_SOCIETES_SOCIETE_ID_FKEY =
          Internal.createForeignKey(
              ...
              new TableField[] {Societes.SOCIETES.ID},
              true);
  public static final ForeignKey<UserSocietesRecord, UsersRecord>
      USER_SOCIETES__USER_SOCIETES_USER_ID_FKEY =
          Internal.createForeignKey(
              UserSocietes.USER_SOCIETES,
              DSL.name("user_societes_user_id_fkey"),
              new TableField[] {UserSocietes.USER_SOCIETES.USER_ID},
              Keys.USERS_PKEY,
              new TableField[] {Users.USERS.ID},
              true);
}
