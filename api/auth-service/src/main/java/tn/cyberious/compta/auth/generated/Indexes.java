...
public class Indexes {
    ...
    public static final Index IDX_AUTH_LOGS_CREATED_AT = Internal.createIndex(DSL.name("idx_auth_logs_created_at"), AuthLogs.AUTH_LOGS, new OrderField[] { AuthLogs.AUTH_LOGS.CREATED_AT }, false);
    public static final Index IDX_AUTH_LOGS_USER_ID = Internal.createIndex(DSL.name("idx_auth_logs_user_id"), AuthLogs.AUTH_LOGS, new OrderField[] { AuthLogs.AUTH_LOGS.USER_ID }, false);
    ...
    public static final Index IDX_REFRESH_TOKENS_TOKEN = Internal.createIndex(DSL.name("idx_refresh_tokens_token"), RefreshTokens.REFRESH_TOKENS, new OrderField[] { RefreshTokens.REFRESH_TOKENS.TOKEN }, false);
    ...
    public static final Index IDX_USERS_IS_ACTIVE = Internal.createIndex(DSL.name("idx_users_is_active"), Users.USERS, new OrderField[] { Users.USERS.IS_ACTIVE }, false);
