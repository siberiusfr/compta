...
public class UserRoles extends TableImpl<UserRolesRecord> {
    ...
    /**
     * The reference instance of <code>oauth2.user_roles</code>
     */
    ...
    /**
     * The column <code>oauth2.user_roles.user_id</code>.
     */
    public final TableField<UserRolesRecord, UUID> USER_ID = createField(DSL.name("user_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>oauth2.user_roles.role_id</code>.
     */
    public final TableField<UserRolesRecord, UUID> ROLE_ID = createField(DSL.name("role_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>oauth2.user_roles.assigned_at</code>.
     */
    public final TableField<UserRolesRecord, LocalDateTime> ASSIGNED_AT = createField(DSL.name("assigned_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    /**
     * Create an aliased <code>oauth2.user_roles</code> table reference
     */
    ...
    /**
     * Create a <code>oauth2.user_roles</code> table reference
     */
    public UserRoles() {
    ...
    /**
     * Get the implicit join path to the <code>oauth2.roles</code> table.
     */
    ...
    /**
     * Get the implicit join path to the <code>oauth2.users</code> table.
     */
