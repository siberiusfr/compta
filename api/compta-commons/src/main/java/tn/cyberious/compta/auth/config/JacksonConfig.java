...
/**
 * Configuration Jackson pour la sérialisation/désérialisation JSON. Configure le support pour : -
 * java.time (LocalDate, LocalDateTime, etc.) - Optional, OptionalInt, etc. - Noms de paramètres des
 * constructeurs
 */
@Configuration
