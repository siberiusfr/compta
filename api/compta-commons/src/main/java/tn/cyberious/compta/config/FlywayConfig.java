 ...
 * Un service peut fournir son propre FlywayMigrationStrategy pour remplacer celui-ci.
 */
@Configuration
public class FlywayConfig {
     ...
     * Les migrations sont exécutées automatiquement au démarrage si:
     * - flyway.enabled=true
     * - compta.flyway.auto-migrate=true (défaut: true)
     *
     * Pour désactiver l'exécution automatique tout en gardant Flyway pour la consultation,
     * mettre compta.flyway.auto-migrate=false dans application.yml
     *
     * Ce bean est conditionnel et ne sera pas créé si un service définit son propre FlywayMigrationStrategy.
     */
    @Bean
