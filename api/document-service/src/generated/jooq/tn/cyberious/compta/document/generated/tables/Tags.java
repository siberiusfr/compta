...
public class Tags extends TableImpl<TagsRecord> {
    ...
    /**
     * The reference instance of <code>document.tags</code>
     */
    ...
    /**
     * The column <code>document.tags.id</code>.
     */
    public final TableField<TagsRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>document.tags.name</code>.
     */
    public final TableField<TagsRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>document.tags.created_at</code>.
     */
    public final TableField<TagsRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    /**
     * Create an aliased <code>document.tags</code> table reference
     */
    ...
    /**
     * Create a <code>document.tags</code> table reference
     */
    public Tags() {
    ...
    public DocumentTagsPath documentTags() {
        if (_documentTags == null)
            _documentTags = new DocumentTagsPath(this, null, Keys.DOCUMENT_TAGS__DOCUMENT_TAGS_TAG_ID_FKEY.getInverseKey());
     ...
     * <code>document.documents</code> table
     */
    public DocumentsPath documents() {
        return documentTags().documents();
    }

    @Override
    public TableField<TagsRecord, LocalDateTime> getRecordTimestamp() {
        return CREATED_AT;
    }
