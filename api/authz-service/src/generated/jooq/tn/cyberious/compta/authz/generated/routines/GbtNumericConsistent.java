...
public class GbtNumericConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_numeric_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtNumericConsistent() {
        super("gbt_numeric_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
