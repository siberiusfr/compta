...
public class GbtTextConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_text_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtTextConsistent() {
        super("gbt_text_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
