...
public class GbtTimeConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_time_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtTimeConsistent() {
        super("gbt_time_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
