...
public class TsDist extends AbstractRoutine<YearToSecond> {
    ...
    /**
     * The parameter <code>authz.ts_dist.RETURN_VALUE</code>.
     */
     ...
     */
    public TsDist() {
        super("ts_dist", Authz.AUTHZ, SQLDataType.INTERVAL);
