...
public class GbtUuidConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_uuid_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtUuidConsistent() {
        super("gbt_uuid_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
