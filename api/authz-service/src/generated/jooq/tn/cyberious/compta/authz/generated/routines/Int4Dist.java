...
public class Int4Dist extends AbstractRoutine<Integer> {
     ...
     */
    public Int4Dist() {
        super("int4_dist", Authz.AUTHZ, SQLDataType.INTEGER);
