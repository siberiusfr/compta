...
public class GbtIntvDistance extends AbstractRoutine<Double> {
    ...
    /**
     * The parameter <code>authz.gbt_intv_distance.RETURN_VALUE</code>.
     */
    ...
    public GbtIntvDistance() {
        super("gbt_intv_distance", Authz.AUTHZ, SQLDataType.DOUBLE);
