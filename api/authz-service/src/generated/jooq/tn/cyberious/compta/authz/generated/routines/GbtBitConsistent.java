...
public class GbtBitConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_bit_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtBitConsistent() {
        super("gbt_bit_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
