...
public class GbtTsDistance extends AbstractRoutine<Double> {
    ...
    /**
     * The parameter <code>authz.gbt_ts_distance.RETURN_VALUE</code>.
     */
    ...
    public GbtTsDistance() {
        super("gbt_ts_distance", Authz.AUTHZ, SQLDataType.DOUBLE);
