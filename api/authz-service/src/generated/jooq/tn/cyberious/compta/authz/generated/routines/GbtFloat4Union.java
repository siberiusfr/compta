...
public class GbtFloat4Union extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", DefaultDataType.getDefaultDataType("\"authz\".\"gbtreekey8\""), false, false);
    ...
    public GbtFloat4Union() {
        super("gbt_float4_union", Authz.AUTHZ, DefaultDataType.getDefaultDataType("\"authz\".\"gbtreekey8\""));
