...
public class GbtInt2Distance extends AbstractRoutine<Double> {
    ...
    /**
     * The parameter <code>authz.gbt_int2_distance.RETURN_VALUE</code>.
     */
    ...
    public GbtInt2Distance() {
        super("gbt_int2_distance", Authz.AUTHZ, SQLDataType.DOUBLE);
