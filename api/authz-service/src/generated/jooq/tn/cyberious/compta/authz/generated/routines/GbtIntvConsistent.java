...
public class GbtIntvConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_intv_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtIntvConsistent() {
        super("gbt_intv_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
