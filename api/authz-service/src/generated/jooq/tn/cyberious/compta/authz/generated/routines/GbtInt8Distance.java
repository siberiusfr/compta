...
public class GbtInt8Distance extends AbstractRoutine<Double> {
    ...
    /**
     * The parameter <code>authz.gbt_int8_distance.RETURN_VALUE</code>.
     */
    ...
    public GbtInt8Distance() {
        super("gbt_int8_distance", Authz.AUTHZ, SQLDataType.DOUBLE);
