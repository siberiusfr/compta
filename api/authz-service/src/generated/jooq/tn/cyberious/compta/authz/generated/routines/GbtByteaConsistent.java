...
public class GbtByteaConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_bytea_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtByteaConsistent() {
        super("gbt_bytea_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
