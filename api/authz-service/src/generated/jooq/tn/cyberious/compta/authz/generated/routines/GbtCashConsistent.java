...
public class GbtCashConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_cash_consistent.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>authz.gbt_cash_consistent._3</code>.
     */
    public static final Parameter<Short> _3 = Internal.createParameter("_3", SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>authz.gbt_cash_consistent._4</code>.
     */
    ...
    public GbtCashConsistent() {
        super("gbt_cash_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
