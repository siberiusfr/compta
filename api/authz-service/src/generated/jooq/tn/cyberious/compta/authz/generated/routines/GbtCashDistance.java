...
public class GbtCashDistance extends AbstractRoutine<Double> {
    ...
    /**
     * The parameter <code>authz.gbt_cash_distance.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>authz.gbt_cash_distance._3</code>.
     */
    public static final Parameter<Short> _3 = Internal.createParameter("_3", SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>authz.gbt_cash_distance._4</code>.
     */
    ...
    public GbtCashDistance() {
        super("gbt_cash_distance", Authz.AUTHZ, SQLDataType.DOUBLE);
