...
public class GbtInetConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_inet_consistent.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>authz.gbt_inet_consistent._3</code>.
     */
    public static final Parameter<Short> _3 = Internal.createParameter("_3", SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>authz.gbt_inet_consistent._4</code>.
     */
    ...
    public GbtInetConsistent() {
        super("gbt_inet_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
