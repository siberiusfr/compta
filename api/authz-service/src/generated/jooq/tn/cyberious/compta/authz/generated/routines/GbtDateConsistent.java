...
public class GbtDateConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_date_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtDateConsistent() {
        super("gbt_date_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
