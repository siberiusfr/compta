...
public class GbtTsConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_ts_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtTsConsistent() {
        super("gbt_ts_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
