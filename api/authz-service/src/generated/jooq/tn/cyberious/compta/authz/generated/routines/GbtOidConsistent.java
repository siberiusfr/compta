...
public class GbtOidConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_oid_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtOidConsistent() {
        super("gbt_oid_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
