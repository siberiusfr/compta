...
public class GbtOidDistance extends AbstractRoutine<Double> {
    ...
    /**
     * The parameter <code>authz.gbt_oid_distance.RETURN_VALUE</code>.
     */
    ...
    public GbtOidDistance() {
        super("gbt_oid_distance", Authz.AUTHZ, SQLDataType.DOUBLE);
