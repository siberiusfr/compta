...
public class GbtTimeDistance extends AbstractRoutine<Double> {
    ...
    /**
     * The parameter <code>authz.gbt_time_distance.RETURN_VALUE</code>.
     */
    ...
    public GbtTimeDistance() {
        super("gbt_time_distance", Authz.AUTHZ, SQLDataType.DOUBLE);
