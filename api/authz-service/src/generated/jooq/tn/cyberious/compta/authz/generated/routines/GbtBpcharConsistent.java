...
public class GbtBpcharConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>authz.gbt_bpchar_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtBpcharConsistent() {
        super("gbt_bpchar_consistent", Authz.AUTHZ, SQLDataType.BOOLEAN);
