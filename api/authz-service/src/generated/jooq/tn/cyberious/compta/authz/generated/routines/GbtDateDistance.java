...
public class GbtDateDistance extends AbstractRoutine<Double> {
    ...
    /**
     * The parameter <code>authz.gbt_date_distance.RETURN_VALUE</code>.
     */
    ...
    public GbtDateDistance() {
        super("gbt_date_distance", Authz.AUTHZ, SQLDataType.DOUBLE);
