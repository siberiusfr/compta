...
public class Societes extends TableImpl<SocietesRecord> {
    ...
    /**
     * The column <code>authz.societes.id</code>.
     */
    public final TableField<SocietesRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>authz.societes.raison_sociale</code>.
     */
    public final TableField<SocietesRecord, String> RAISON_SOCIALE = createField(DSL.name("raison_sociale"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>authz.societes.matricule_fiscale</code>.
     */
    public final TableField<SocietesRecord, String> MATRICULE_FISCALE = createField(DSL.name("matricule_fiscale"), SQLDataType.VARCHAR(13).nullable(false), this, "");

    /**
     * The column <code>authz.societes.code_tva</code>.
     */
    public final TableField<SocietesRecord, String> CODE_TVA = createField(DSL.name("code_tva"), SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>authz.societes.code_douane</code>.
     */
    public final TableField<SocietesRecord, String> CODE_DOUANE = createField(DSL.name("code_douane"), SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>authz.societes.registre_commerce</code>.
     */
    public final TableField<SocietesRecord, String> REGISTRE_COMMERCE = createField(DSL.name("registre_commerce"), SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>authz.societes.forme_juridique</code>.
     */
    public final TableField<SocietesRecord, String> FORME_JURIDIQUE = createField(DSL.name("forme_juridique"), SQLDataType.VARCHAR(100), this, "");

    /**
     * The column <code>authz.societes.capital_social</code>.
     */
    public final TableField<SocietesRecord, BigDecimal> CAPITAL_SOCIAL = createField(DSL.name("capital_social"), SQLDataType.NUMERIC(15, 2), this, "");

    /**
     * The column <code>authz.societes.date_creation</code>.
     */
    public final TableField<SocietesRecord, LocalDate> DATE_CREATION = createField(DSL.name("date_creation"), SQLDataType.LOCALDATE, this, "");

    /**
     * The column <code>authz.societes.adresse</code>.
     */
    public final TableField<SocietesRecord, String> ADRESSE = createField(DSL.name("adresse"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>authz.societes.ville</code>.
     */
    public final TableField<SocietesRecord, String> VILLE = createField(DSL.name("ville"), SQLDataType.VARCHAR(100), this, "");

    /**
     * The column <code>authz.societes.code_postal</code>.
     */
    public final TableField<SocietesRecord, String> CODE_POSTAL = createField(DSL.name("code_postal"), SQLDataType.VARCHAR(10), this, "");

    /**
     * The column <code>authz.societes.telephone</code>.
     */
    public final TableField<SocietesRecord, String> TELEPHONE = createField(DSL.name("telephone"), SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>authz.societes.fax</code>.
     */
    public final TableField<SocietesRecord, String> FAX = createField(DSL.name("fax"), SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>authz.societes.email</code>.
     */
    public final TableField<SocietesRecord, String> EMAIL = createField(DSL.name("email"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>authz.societes.site_web</code>.
     */
    public final TableField<SocietesRecord, String> SITE_WEB = createField(DSL.name("site_web"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>authz.societes.activite</code>.
     */
    public final TableField<SocietesRecord, String> ACTIVITE = createField(DSL.name("activite"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>authz.societes.secteur</code>.
     */
    ...
    /**
     * The column <code>authz.societes.created_at</code>.
     */
    public final TableField<SocietesRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    private Societes(Name alias, Table<SocietesRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.table(), where);
    }

    /**
     * Create an aliased <code>authz.societes</code> table reference
     */
    ...
    /**
     * Create a <code>authz.societes</code> table reference
     */
    public Societes() {
        this(DSL.name("societes"), null);
    }

    public <O extends Record> Societes(Table<O> path, ForeignKey<O, SocietesRecord> childPath, InverseForeignKey<O, SocietesRecord> parentPath) {
    ...
    public static class SocietesPath extends Societes implements Path<SocietesRecord> {
        ...
        private static final long serialVersionUID = 1L;
        public <O extends Record> SocietesPath(Table<O> path, ForeignKey<O, SocietesRecord> childPath, InverseForeignKey<O, SocietesRecord> parentPath) {
    ...
    public ComptableSocietesPath comptableSocietes() {
        if (_comptableSocietes == null)
            _comptableSocietes = new ComptableSocietesPath(this, null, Keys.COMPTABLE_SOCIETES__COMPTABLE_SOCIETES_SOCIETE_ID_FKEY.getInverseKey());
    ...
    /**
     * Get the implicit to-many join path to the
     * <code>authz.user_societes</code> table
     */
