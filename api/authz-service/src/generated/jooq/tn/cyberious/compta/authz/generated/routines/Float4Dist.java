...
public class Float4Dist extends AbstractRoutine<Float> {
     ...
     */
    public Float4Dist() {
        super("float4_dist", Authz.AUTHZ, SQLDataType.REAL);
