...
public class GbtInt4Distance extends AbstractRoutine<Double> {
    ...
    /**
     * The parameter <code>authz.gbt_int4_distance.RETURN_VALUE</code>.
     */
    ...
    public GbtInt4Distance() {
        super("gbt_int4_distance", Authz.AUTHZ, SQLDataType.DOUBLE);
