...
@Tag(
    name = "Utilisateurs Societe",
    description = "Gestion des utilisateurs appartenant aux societes clientes")
public class UserSocietesController {
  ...
  @Operation(
      ...
      description = "Assigne un utilisateur a une societe cliente avec un rôle")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Change le rôle d'un utilisateur dans sa societe")
  @ApiResponses({
  ...
  public ResponseEntity<UserSocietesDto> updateRole(
      ...
      @Parameter(description = "Nouveau rôle (MANAGER, FINANCE, VIEWER)") @RequestParam
          String role) {
  ...
  @Operation(
      ...
      description = "Desactive l'assignation d'un utilisateur a sa societe")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Recupere l'assignation d'un utilisateur a sa societe")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Assignation trouvee"),
  ...
  @Operation(
      ...
      description = "Recupere tous les utilisateurs d'une societe cliente")
  ...
  @Operation(
      ...
      description = "Recupere les utilisateurs actifs d'une societe cliente")
  ...
  @Operation(
      ...
      description = "Recupere le manager d'une societe cliente")
  ...
  @Operation(
      ...
      description = "Recupere la societe a laquelle appartient l'utilisateur")
