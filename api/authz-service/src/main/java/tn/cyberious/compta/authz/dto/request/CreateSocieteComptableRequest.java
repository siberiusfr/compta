...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Requête de creation d'une societe comptable")
public class CreateSocieteComptableRequest {
    ...
    @Schema(description = "Raison sociale", example = "Cabinet Expert Comptable SARL", required = true)
    ...
    @Schema(description = "Matricule fiscale (13 caracteres)", example = "1234567ABC000", required = true)
