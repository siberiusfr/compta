...
public class SocieteComptableController {
  ...
  @Operation(
      ...
      description = "Cree un nouveau cabinet comptable")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Met a jour les informations d'un cabinet comptable")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Supprime un cabinet comptable s'il n'a pas de societes clientes")
  @ApiResponses({
    @ApiResponse(responseCode = "204", description = "Societe comptable supprimee"),
    @ApiResponse(responseCode = "404", description = "Societe comptable non trouvee"),
    @ApiResponse(
        responseCode = "400",
        description = "Impossible de supprimer: societes clientes existantes")
  })
  ...
  @Operation(
      ...
      description = "Recupere les details d'un cabinet comptable par son ID")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Recupere un cabinet comptable par son matricule fiscale")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Societe comptable trouvee"),
    @ApiResponse(responseCode = "404", description = "Societe comptable non trouvee")
  })
  ...
  @Operation(
      ...
      description = "Recupere la liste de tous les cabinets comptables")
  ...
  @Operation(
      ...
      description = "Recupere uniquement les cabinets comptables actifs")
