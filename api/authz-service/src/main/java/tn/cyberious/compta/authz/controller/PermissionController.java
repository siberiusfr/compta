...
public class PermissionController {
  ...
  @Operation(
      ...
      description = "Cree une nouvelle permission granulaire")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Met a jour la description d'une permission")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Supprime une permission et ses associations aux rôles")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Recupere une permission par son ID")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Recupere une permission par son code unique")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Permission trouvee"),
    @ApiResponse(responseCode = "404", description = "Permission non trouvee")
  })
  ...
  @Operation(
      ...
      description = "Recupere la liste de toutes les permissions")
  ...
  @Operation(
      ...
      description = "Recupere les permissions d'une ressource")
  ...
  @Operation(
      ...
      description = "Recupere la liste des ressources distinctes")
  ...
  @Operation(
      ...
      description = "Recupere la liste des actions distinctes")
  ...
  @Operation(
      ...
      description = "Associe une permission a un rôle")
  @ApiResponses({
    @ApiResponse(responseCode = "201", description = "Permission assignee avec succes"),
    @ApiResponse(
        responseCode = "400",
        description = "Permission deja assignee ou donnees invalides")
  })
  ...
  @Operation(
      ...
      description = "Recupere toutes les permissions associees a un rôle")
  ...
  @Operation(
      ...
      description = "Recupere les assignations role-permission d'un rôle")
  ...
  @Operation(
      ...
      description = "Recupere la liste des rôles ayant des permissions")
  ...
  @Operation(
      ...
      description = "Verifie si un rôle possede une permission")
  ...
  @Operation(
      ...
      description = "Verifie si un rôle a acces a une ressource avec une action")
  @ApiResponse(responseCode = "200", description = "Resultat de la verification")
