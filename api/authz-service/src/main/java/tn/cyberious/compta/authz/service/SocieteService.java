...
public class SocieteService {
    ...
    public SocieteDto update(Long id, UpdateSocieteRequest request) {
        Societes existing = societeRepository.findById(id)
    ...
    public SocieteDto findByMatriculeFiscale(String matriculeFiscale) {
        return societeRepository.findByMatriculeFiscale(matriculeFiscale)
                .map(this::toDto)
    ...
    public List<SocieteDto> findAllActive() {
        return societeRepository.findAllActive().stream()
                .map(this::toDto)
                .toList();
    }
    ...
    public List<SocieteDto> search(String searchTerm) {
        return societeRepository.searchByRaisonSociale(searchTerm).stream()
                .map(this::toDto)
                .toList();
    }
    ...
    public List<SocieteDto> findBySecteur(String secteur) {
        return societeRepository.findBySecteur(secteur).stream()
                .map(this::toDto)
                .toList();
    }
