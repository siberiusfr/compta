...
public class ComptableSocietesRepository {
    ...
    public ComptableSocietes insert(ComptableSocietes comptableSociete) {
        LocalDate dateDebut = comptableSociete.getDateDebut() != null
                ? comptableSociete.getDateDebut()
                : LocalDate.now();
        ...
        ComptableSocietesRecord record = dsl.insertInto(COMPTABLE_SOCIETES)
                ...
                .set(COMPTABLE_SOCIETES.CAN_READ, comptableSociete.getCanRead() != null ? comptableSociete.getCanRead() : true)
                .set(COMPTABLE_SOCIETES.CAN_WRITE, comptableSociete.getCanWrite() != null ? comptableSociete.getCanWrite() : false)
                .set(COMPTABLE_SOCIETES.CAN_VALIDATE, comptableSociete.getCanValidate() != null ? comptableSociete.getCanValidate() : false)
