...
@Tag(name = "Acces Comptables", description = "Gestion des acces des comptables aux societes clientes")
public class ComptableSocietesController {

    private final ComptableSocietesService comptableSocietesService;

    @PostMapping
    @Operation(summary = "Assigner un comptable a une societe", description = "Donne acces a un comptable sur une societe cliente")
    @ApiResponses({
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Modifier les droits d'acces", description = "Met a jour les droits d'un comptable sur une societe")
    @ApiResponses({
    ...
    @Operation(summary = "Revoquer l'acces", description = "Revoque l'acces d'un comptable a une societe")
    @ApiResponses({
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Recuperer un acces", description = "Recupere les details d'un acces par son ID")
    @ApiResponses({
    ...
    @Operation(summary = "Recuperer l'acces utilisateur-societe", description = "Recupere l'acces d'un utilisateur sur une societe")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Acces trouve"),
        @ApiResponse(responseCode = "404", description = "Acces non trouve")
    })
    ...
    @Operation(summary = "Lister les acces d'un utilisateur", description = "Recupere tous les acces d'un comptable")
    ...
    @Operation(summary = "Lister les acces actifs", description = "Recupere les acces actifs d'un comptable")
    ...
    @Operation(summary = "Lister les comptables d'une societe", description = "Recupere tous les comptables ayant acces a une societe")
    @ApiResponse(responseCode = "200", description = "Liste des acces")
    ...
    @Operation(summary = "Lister les societes accessibles", description = "Recupere les societes auxquelles un comptable a acces")
    ...
    @Operation(summary = "Lister les societes en ecriture", description = "Recupere les societes où le comptable a le droit d'ecriture")
    ...
    @Operation(summary = "Verifier l'acces", description = "Verifie si un comptable a acces a une societe")
    ...
    @Operation(summary = "Verifier le droit d'ecriture", description = "Verifie si un comptable a le droit d'ecriture sur une societe")
    @ApiResponse(responseCode = "200", description = "Resultat de la verification")
    ...
    @Operation(summary = "Verifier le droit de validation", description = "Verifie si un comptable a le droit de validation sur une societe")
    @ApiResponse(responseCode = "200", description = "Resultat de la verification")
