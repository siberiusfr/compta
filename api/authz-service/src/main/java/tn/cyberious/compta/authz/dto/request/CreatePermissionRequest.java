...
public class CreatePermissionRequest {
    ...
    @Schema(description = "Code unique de la permission", example = "JOURNAL_ENTRY_CREATE", required = true)
    private String code;
    ...
    @Schema(description = "Description de la permission", example = "Permet de creer des ecritures comptables")
