...
public class SocieteController {
  ...
  @Operation(
      ...
      description = "Cree une nouvelle societe cliente")
  @ApiResponses({
    @ApiResponse(responseCode = "201", description = "Societe creee avec succes"),
    @ApiResponse(
        responseCode = "400",
        description = "Donnees invalides ou matricule fiscale deja existant")
  })
  ...
  @Operation(
      ...
      description = "Met a jour les informations d'une societe cliente")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Supprime une societe cliente")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Recupere les details d'une societe cliente par son ID")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Recupere une societe cliente par son matricule fiscale")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Societe trouvee"),
    @ApiResponse(responseCode = "404", description = "Societe non trouvee")
  })
  public ResponseEntity<SocieteDto> findByMatriculeFiscale(
      @Parameter(description = "Matricule fiscale (13 caracteres)") @PathVariable
  ...
  @Operation(
      ...
      description = "Recupere la liste de toutes les societes clientes")
  ...
  @Operation(
      ...
      description = "Recupere uniquement les societes clientes actives")
  ...
  @Operation(
      ...
      description = "Recupere les societes gerees par un cabinet comptable")
  @ApiResponse(responseCode = "200", description = "Liste des societes")
  ...
  @Operation(
      ...
      description = "Recupere les societes actives gerees par un cabinet comptable")
  @ApiResponse(responseCode = "200", description = "Liste des societes actives")
  ...
  @Operation(
      ...
      description = "Recherche par raison sociale (recherche partielle)")
  ...
  @Operation(
      ...
      description = "Recupere les societes clientes d'un secteur d'activite")
