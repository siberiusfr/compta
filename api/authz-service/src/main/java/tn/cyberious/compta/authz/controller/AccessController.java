...
@Tag(
    name = "Acces Unifie",
    description = "Verification unifiee des acces utilisateur (comptable ou membre)")
public class AccessController {
  ...
  @Operation(
      ...
      description =
          "Retourne les details complets d'acces d'un utilisateur a une societe. "
              + "L'acces peut etre de type COMPTABLE (via comptable_societes) ou MEMBRE (via user_societes).")
  @ApiResponses({@ApiResponse(responseCode = "200", description = "Details d'acces retournes")})
  ...
  @Operation(
      ...
      description =
          "Verifie rapidement si un utilisateur a acces a une societe (comptable OU membre)")
  ...
  @Operation(
      ...
      description =
          "Retourne toutes les societes auxquelles un utilisateur a acces, "
  ...
  @Operation(
      ...
      description =
          "Retourne uniquement les societes sur lesquelles l'utilisateur a le droit d'ecriture")
  ...
  @Operation(
      ...
      description =
          "Invalide tout le cache d'acces utilisateur. A utiliser apres des modifications massives.")
