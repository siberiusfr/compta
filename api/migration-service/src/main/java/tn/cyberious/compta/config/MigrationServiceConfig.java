...
/**
 * Configuration pour le service de migration.
...
public class MigrationServiceConfig {
    ...
    /**
     * Stratégie de migration qui ne fait rien.
     * Les migrations ne sont plus exécutées automatiquement par ce service.
     * Chaque service applicatif gère ses propres migrations.
     */
    @Bean
