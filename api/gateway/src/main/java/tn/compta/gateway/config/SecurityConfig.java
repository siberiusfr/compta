...
public class SecurityConfig {
  ...
  public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
    http
        ...
        .cors(ServerHttpSecurity.CorsSpec::disable) // Disable for dev, configure properly in production
   ...
   * IMPORTANT: MacAlgorithm.HS256 must be specified for proper JWT validation.
   */
  @Bean
  public ReactiveJwtDecoder jwtDecoder() {
    ...
    // ✅ CRITICAL: Specify MacAlgorithm.HS256 for HMAC-SHA256
